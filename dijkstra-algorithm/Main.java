// ====================================================================
// CPSC 319, W25, PA-4: Dijkstra’s Algorithm with Linked Lists and Priority Queue 
//
// Student Information:
//
...
//
// ====================================================================
// This assignment was completed by Nethanya Dhaiphule. No AI tools were used. 
...
class SinglyLinkedList {
    ...
    // it's useful to understand how ordered lists work in adjacency
    // representations.
...
class Graph {
    ...
    // TODO #1: Add a directed edge from 'source' to 'destination' with the given
    // weight.
    //
    // ** Core to building the graph (adjacency list logic). Students should write
    // this. **
    //
    ...
    // create a new SinglyLinkedList for it first, then add the destination node to
    // it.
    //
    // PSEUDOCODE:
    ...
    // It returns true if the node is present in the adjacency list, false
    // otherwise.
    public boolean containsNode(String node) {

        // The adjacencyList is a map that stores each node as a key.
        // If the node is present as a key in the map, it means the graph knows about
        // it.
        ...
        while (!pq.isEmpty()) {
            ...
            for (int i = 0; i < neighbors.size(); i++) {
                ...
                if (newDist < knownDistance) 
                {
                    ...
                    Map.Entry<String, Integer> neighborEntry = new AbstractMap.SimpleEntry<>(edge.destination, newDist);
                    pq.add(neighborEntry);
    ...
    public void loadGraphFromFile(String filename) throws IOException {
        ...
        // FileReader opens the file, and BufferedReader allows efficient reading of
        // text.
        ...
        // Read the file one line at a time until we reach the end (i.e., readLine()
        // returns null).
        while ((line = br.readLine()) != null) {

            // If the line starts with '#' (a comment) or is blank/empty, skip it.
            // This allows students to comment out lines or leave spacing in their input
            // file.
            if (line.startsWith("#") || line.isBlank())
                continue;

            // Split the line into parts using whitespace (spaces, tabs, etc.) as
            // separators.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // If the user types 'exit' (case-insensitive), break the loop and end the
            // program.
